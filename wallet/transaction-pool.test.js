...
describe('TransactionPool', () => {
   ...
   beforeEach(() => {
      ...
      wallet = new Wallet();
      bc = new Blockchain();
      transaction = wallet.createTransaction('r4nd0m335', 30, bc, tp);
   });
   ...
   describe('mixing valid and corrupt transactions', () => {
      ...
      beforeEach(() => {
         ...
         for(let i=0; i<6; i++) {
            wallet = new Wallet();
            transaction = wallet.createTransaction('r4ndom-addr3$$', 30, bc, tp);
            if(i%2==0) {
      ...
      it('Shows a difference betweeen valid and corrupt transactions', () => {
